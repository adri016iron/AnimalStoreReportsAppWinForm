...
namespace TiendaAnimales
{
    public partial class Graficos : Form
    {
        ...
        {
            GraficosAdoptados graficosAdoptados = new GraficosAdoptados();
            graficosAdoptados.Show();
        }

        private void button5_Click(object sender, EventArgs e)
        {
            GraficosPrecioMedioCategoria graficosPrecioMedioCategoria = new GraficosPrecioMedioCategoria();
            graficosPrecioMedioCategoria.Show();
        }

        private void button6_Click(object sender, EventArgs e)
        {
            GraficosClientesEmail graficosClientesEmail = new GraficosClientesEmail();
            graficosClientesEmail.Show();
        }

        private void button7_Click(object sender, EventArgs e)
        {
            GraficosClientesInicial graficosClientesInicial = new GraficosClientesInicial();
            graficosClientesInicial.Show();
        }

        private void button8_Click(object sender, EventArgs e)
        {
            GraficosProductosStockBajo graficosProductosStockBajo = new GraficosProductosStockBajo();
            graficosProductosStockBajo.Show();
        }
