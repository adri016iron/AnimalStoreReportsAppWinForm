    ...
    public partial class Index : Form
    {
        ...
        private void Index_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string rutaInformeAdopcion = Path.Combine(Application.StartupPath, "Service", "tablaAdopcionIndex.rdlc");
                string rutaInformeClientes = Path.Combine(Application.StartupPath, "Service", "tablaClientesIndex.rdlc");
